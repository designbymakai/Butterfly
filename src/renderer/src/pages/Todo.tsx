...
const Todo = forwardRef((_, ref) => {
  ...
  return (
    <div className='w-full h-full p-4 bg-b-white-100 rounded-3xl overflow-scroll no-scrollbar'>
      <h1 className='text-2xl text-b-black-100'>Tasks</h1>
        ...
        <div>
          <div className='flex mb-4 items-center'>
            ...
            <button
              ...
              className={`p-1 px-2 mr-2 rounded ${filterProject === '' ? 'bg-b-blue-400 text-white' : 'bg-gray-200 text-black'}`}
            >
              All Tasks
            </button>
            ...
            {projects.map((project, index) => (
              <button
                ...
                className={`p-1 px-2 rounded ml-2 hover:bg-b-blue-100 hover:text-b-white-100 ${filterProject === project.name ? 'bg-b-blue-300 text-white' : 'bg-gray-200 text-black'}`}
            ...
            <button
              ...
              className={`p-1 rounded ml-2 hover:bg-b-blue-100 hover:text-b-white-100 ${filterProject === 'No Project' ? 'bg-b-blue-300 text-white' : 'bg-gray-200 text-black'}`}
            >
              Unassigned
            </button>
            </div>
            <button onClick={handleOpenModal} className='p-1 text-b-black-400 rounded ml-2'>
